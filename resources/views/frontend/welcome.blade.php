                ...
                <div class="utf_right_side">
                  <div class="header_widget">
                    ...
                    {% if user.is_authenticated %}
                      ...
                      <a href="{% url 'account_logout' %}" class="button border with-icon"><i class="sl sl-icon-user"></i> Излез</a>
                    {% else %}
                      <a href="{% url 'account_login' %}" class="button border sign-in"><i class="fa fa-sign-in"></i> Вход</a>
                      <a href="{% url 'account_signup' %}" class="button border with-icon"><i class="sl sl-icon-user"></i> Регистрирай се</a>
                    {% endif %}
                    <!--{% if user.is_authenticated %}-->
                    {{-- <!--<p>Welcome {{ user.username }} !!!</p>--> --}}
                    <!--<p><a href="{% url 'account_logout' %}">Излез</a>-->
