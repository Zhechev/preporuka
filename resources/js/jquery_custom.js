    ...
    $(document).ready(function() {
        ...
        $('.menu-trigger').on('click', function() {
            ...
            if (jpm.hasClass('active')) {
                ...
                jPanelMenu.open();
                jpm.addClass('active');
                $('#utf_panel_menu').removeClass('menu');
                $('ul#utf_panel_menu li').removeClass('dropdown');
                $('ul#utf_panel_menu li ul').removeAttr('style');
                $('ul#utf_panel_menu li div').removeClass('mega').removeAttr('style');
                $('ul#utf_panel_menu li div div').removeClass('mega-container');
            }
            return false;
        });
        ...
        $(window).on('load resize', function() {
            $('.utf_dashboard_stat_content h4').counterUp({
                delay: 100,
                time: 800
            });
        });
